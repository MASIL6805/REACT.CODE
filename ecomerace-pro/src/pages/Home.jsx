...
import shop2Image from '../assets/images/shop2.jpg'
    ...
    <div className='bg-white mt-2 px-4 md:px-16 lg:px-24'>
        <div className='container mx-auto py-4 flex flex-col md:flex-row '>
            <div className='w-full md:w-3/12'>
                ...
                <ul className='space-y-4 bg-gray-100 p-3 boader'>
                ...
                <div className='w-full md:w-9/12 mt-8 md:mt-0 h-96 relative'> 
                    <img src={shop2Image} alt="pic"  className='h-full w-full'/>
                    <div className='absolute top-16 left-8' > 
                <p className='text-grey-600 md-4'>Code with Masil</p>
